			...
			link: function(scope, element) {
				...
				var render = function() {
					...
					bar.append("text")
						...
						.attr("y", function(d) { return (d.yIndex+0.8) * yGridSize; })
						.attr("fill","black").attr("font-size",10)
//						.attr("dy",".25em")
						.text(function(d) {return d.value});
//						
						
					bar.selectAll("rect").transition().duration(options.duration).style("fill", function(d) {
